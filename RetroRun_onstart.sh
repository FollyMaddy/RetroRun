...
#uncomment one "feh" line to display an image before and after executing a rom
#(so the windows-screen is not visable)

#uncomment one of these images !
# black carbon_fiber image
